...
POSTS = [
 dict(
  ...
  desc_pt='Amazon, Jaguar, Dunkin e Avon mudaram de identidade. Veja os sinais reais de que sua marca precisa de rebranding, a diferença entre total e parcial, e os riscos de errar a mão.',
 ...
 dict(
  ...
  desc_pt='O grafo social morreu e o grafo de interesse tomou o lugar. Entenda o que mudou nos algoritmos, o que é Generative Engine Optimization e por que storytelling virou requisito técnico.',
